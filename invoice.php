...
<?php
	...
	if( isset($_POST['billmobile']) && isset($_POST['currentlypayingnow']) ){
		$billmobile = mysqli_real_escape_string($db, $_POST['billmobile']);
		$currentlypayingnow = mysqli_real_escape_string($db, $_POST['currentlypayingnow']);
		$currentlypayingnowa = mysqli_real_escape_string($db, $_POST['currentlypayingnowa']);
...
<div id="printable">			
				...
				<tbody>
					<tr>
						<td style="vertical-align:top; padding:5px">
							<strong>JVK ENTERPRISES</strong><br />	
							Prop: <strong>Jakkampudi Srinivas</strong><br>					
							RS No : 310, D-No : 14-302/5, SVG Market,<br>RAJAMAHENDRAVARAM, E.G Dist., (A.P)<br>
							GSTIN : 37BDGPJ5829J1Z6<br>
							Cell: 9804461234
						</td>
						...
						<div id='foot'>
									<table border="0" style="border:none; margin:10px; vertical-align:top" valign="top">
										...
										<tr>
											...
											<td style="border:none; vertical-align:top; padding-left:1em">
												Bank Details
												<p>
													Bank Name : HDFC BANK<br>
													A/C No. : 50200071559209<br>
													IFS Code : HDFC0008219
												</p>
											</td>
										</tr>
									</table>
			...
			<div align="center">
				SUBJECT TO Rajahmundry JURISDICTION<br>
...
<script>
	$(document).ready(function(){
		...
		$(document).on("click", ".printme", function(){
			let existedData = $(".printBlock").html();
			$(".printBlock").html("");
			// body = $("#body").html();
