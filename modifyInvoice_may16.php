		  ...
		  <div class="panel-body">
			...
			<?php
				if( isset($_COOKIE['modifyInvoice']) ){
					...
					$city = $res['city'];
					$address = $res['address'];
					$hamaliCharges = $res['hamaliCharges'];
			...
			<div class='well stockform billingblock table-responsive'>
				...
				<div class='row'>
					<div class='form-group col-md-3'>
						<input type='text' id='customername' class='form-control' value='<?php echo $customername; ?>' placeholder='Customer' hiddenid="<?php echo $customerid ?>" />
					</div>
					<div class='form-group col-md-3'>
					...
					<!-- <div class='form-group col-md-3 col-sm-6 col-xs-12'>
						<input type='text' id='hamaliCharges' class='form-control' placeholder='Hamali Charges' value="<?php echo $hamaliCharges; ?>" />
					</div>	 -->
					<div class='form-group col-md-3 col-sm-6 col-xs-12'>
						<select id='transaction' class='form-control'>
							<option value='<?php echo $transaction; ?>'><?php echo $transaction=="In" ? "Sale" : "Purchase"; ?></option>
					...
					<div class='form-group col-md-3 col-sm-6 col-xs-12'>
						<input type='text' id='openingBalance' readonly disabled class='form-control' style="display:none" placeholder='Opening Balance' />
					</div>
				</div>	
			...
			<div class='well'>
				<div class='row'>
					<div class='form-group col-md-3 col-sm-6 col-xs-12'>
						<select id='fullPayment' class='form-control' <?php echo $transaction=="Out" ? "disabled" : "" ?>>
					...
					<div class='form-group col-md-3 col-sm-3 col-xs-3'>
						...
						<input type='text' placeholder='Pending' class='form-control' id='finalPendingBillAmount' disabled value="<?php echo $finalPendingAmount; ?>" />
					</div>
				</div>
			</div>		

			<!-- <a class='btn btn-xs btn-danger removebillingrow pull-right' ><span class='glyphicon glyphicon-remove'></span> Remove Item</a> -->
			<button id='updateBill' data-username='<?php echo $_SESSION['login']; ?>' data-id='<?php echo $invoiceId; ?>' class='btn btn-md btn-info' >Proceed</button>
