						...
						<?php 
							...
							if( isset($_GET['submit']) ){
								...
								if( !empty($date1) && !empty($date2) ){
									if( $login == "admin" ){
										$qry = "WHERE (`date` BETWEEN '$date1' AND '$date2') AND status='1' AND transaction='In' AND fullPayment='Partial' AND clearanceStatus='0'";
									}else{
									...
									if( $login == "admin" ){
										$qry = "WHERE status='1' AND transaction='In' AND clearanceStatus='0' AND fullPayment='Partial'";
									}else{
								...
								if( $login == "admin" ){
									$qry = "WHERE date='".date('Y-m-d')."' AND status='1' AND transaction='In'AND clearanceStatus='0' AND fullPayment='Partial'";
								}else{
