$(document).ready(function(){
	...
	$('#createcustomer').click(function(){
		...
		customer_customerType = $('#customerType').val();
		...
		$.post("processing.php", {customer_customerType:customer_customerType, customer_gstin:customer_gstin, customer_mobile:customer_mobile, customer_name:customer_name, customer_address:customer_address, customer_state:customer_state, customer_pincode:customer_pincode, customer_city:customer_city}, function(res){
			if( res == true ){
				$('#mobile').val('');	
				$('#name').val('');	
				$('#address').val('');	
