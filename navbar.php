  ...
  <div class="container-fluid" style='padding:0'>
    ...
    <div class="collapse navbar-collapse justnavhead" id="myNavbar">
      <ul class="nav navbar-nav justnav">
		  ...
		  <!-- <li class='<?php echo activemenu("invoices.php"); ?>'><a href="invoices.php"><span class='glyphicon glyphicon-play-circle'></span> Reports</a></li> -->
		  <li class='<?php echo activemenu("balancesheet.php"); ?>'><a href="balancesheet.php"><span class='glyphicon glyphicon-play-circle'></span> Ledger / Reports</a></li>
		  <li class='<?php echo activemenu("balancesheet2.php"); ?>'><a href="balancesheet2.php"><span class='glyphicon glyphicon-play-circle'></span> Ledger / Reports Pur</a></li>
