...
<?php
	...
	if( isset($_POST['billmobile']) && isset($_POST['actualpending']) ){
		...
		$actualpending = mysqli_real_escape_string($db, $_POST['actualpending']);
		$paying = mysqli_real_escape_string($db, $_POST['paying']);
						...
						<tbody>
							<?php 
								...
								while( $res = mysqli_fetch_array($get) ){
									...
									echo "<td>
											<a href='$id' class='btn btn-xs btn-danger del_customer' onclick='return false;'><span class='glyphicon glyphicon-remove'></span></a>
											</td>";
									echo "</tr>";
									$sno++;
								}
