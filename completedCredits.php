						...
						<?php 
							...
							if( isset($_GET['submit']) ){
								...
								if( !empty($date1) && !empty($date2) ){
									if( $login == "admin" ){
										$qry = "WHERE (`date` BETWEEN '$date1' AND '$date2') AND status='1' AND transaction='In' AND fullPayment='Partial' AND clearanceStatus='1'";
									}else{
									...
									if( $login == "admin" ){
										$qry = "WHERE status='1' AND transaction='In' AND clearanceStatus='1' AND fullPayment='Partial'";
									}else{
								...
								if( $login == "admin" ){
									$qry = "WHERE date='".date('Y-m-d')."' AND status='1' AND transaction='In' AND clearanceStatus='1' AND fullPayment='Partial'";
								}else{
							...
							$get = mysqli_query($db, $sql);
								...
								while( $res = mysqli_fetch_array($get) ){
									...
									echo "<td class='text-center'><a class='btn btn-xs btn-info' href='invoice.php?invoice=$id'><span class='glyphicon glyphicon-zoom-in'></span></a></td>";
