...
<?php
	if( isset($_GET['estimateId']) ){
		...
		$partialPayment_estimateId = (float)$res["partialPayment"];

		$currentBillPendingBalance = $payable - $partialPayment_estimateId;
					...
					<tr>
						<td style="margin-bottom:0;">				
							<div style="border-bottom:1px solid black; padding:5px">
								JVK Enterprises<b> (<?php echo (date('Y')-1)."-".date('Y') ?>)</b><br><br><br><br>
							</div>					
							<div style="padding:5px">
								Buyer<br>
			...
			<table class='table table-condensed '>
				...
				<?php 
					...
					$get = mysqli_query($db, $sql);
						...
						$new_os_pending = $new_outstandingBalance + $currentBillPendingBalance;
						...
						echo "<tr>
							<td colspan='6' class='bottomLeftBalances'>
								...
								<p><span style='width:150px; display:inline-block'>Current Balance</span> : <b>$currentBillPendingBalance</b></p>
