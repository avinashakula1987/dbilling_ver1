					...
					<table class='table table-condensed table-bordered' id='datatables'>
						...
						<tbody>
							...
							<?php 
								...
								$sql = "SELECT finaltotal AS totalpurchases, customer, city, state, date, transaction, openingBalance, id, returnStatus, refId, fullPayment, partialPayment, finaltotal as total FROM invoices WHERE login='$login' $dd AND transaction='In' AND status='1' $c $mm";
								$sno = 0;
								...
								// 	</tr>";
									echo  "<tr>
									<td colspan='8'>Total: <b>$tot</b>, Paid So far: <b>$paidd</b>, Pending: <b>$pendd</b></td>
								</tr>";	
							?>					
						</tbody>
					</table>
