						...
						<?php 
							...
							if( isset($_GET['submit']) ){
								...
								if( !empty($date1) && !empty($date2) ){
									if( $login == "admin" ){
										$qry = "WHERE (`date` BETWEEN '$date1' AND '$date2') AND status='0' AND transaction='In'";
									}else{
										$qry = "WHERE (`date` BETWEEN '$date1' AND '$date2') AND status='0' AND transaction='In' AND login='$login'";
									}	
								}else{
									if( $login == "admin" ){
										$qry = "WHERE status='0' AND transaction='In'";
									}else{
								...
								if( $login == "admin" ){
									$qry = "WHERE date='".date('Y-m-d')."' AND status='0' AND transaction='In'";
								}else{
