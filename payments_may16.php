	...
	<div class='row'>
		<div class="panel panel-primary mainbody">
		  ...
		  <div class="panel-body">
			<marquee scrollamount='12' onmouseenter="this.stop()" onmouseleave="this.start()" style='color:red; font-weight:bold'>Page Under Testing, Please don't disturb any record until testing completed &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; - &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Page Under Testing, Please don't disturb any record until testing completed &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; - &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Page Under Testing, Please don't disturb any record until testing completed</marquee>
						...
						<?php 
							...
							if( isset($_GET['submit']) ){
								...
								if( !empty($date1) && !empty($date2) ){
									if( $login == "admin" ){
										$qry = "WHERE (`date` BETWEEN '$date1' AND '$date2') AND status='1' AND transaction='In'";
									}else{
									...
									if( $login == "admin" ){
										$qry = "WHERE status='1' AND transaction='In'";
									}else{
								...
								if( $login == "admin" ){
									$qry = "WHERE date='".date('Y-m-d')."' AND status='1' AND transaction='In'";
								}else{
							...
							$get = mysqli_query($db, $sql);
								...
								while( $res = mysqli_fetch_array($get) ){
									...
									echo "<tr id='row_$id'>";
									echo "<td>$id</td>";
									echo "<td><a href='payment.php?id=$id'>$name</a></td>";
