		...
		<div class='row'>
			...
			<div class="panel-body">	
				<div class="row printBlock">
					<div class='col-md-12'>
						<form action='balancesheet2.php' method='post' style='margin-bottom:10px'>
							<div class="row">
								<div class='col-md-3 '>
									<input type='text' name='customername' class='form-control purchasers_dropdown' placeholder='Customer' value="<?php echo isset($_POST['customername']) ? $_POST['customername'] : ""; ?>"/>
									<?php 
					...
					<table class='table table-condensed table-bordered' id='datatables'>
						...
						<tbody>
							...
							<?php 
								...
								$sql = "SELECT finaltotal AS totalpurchases, customer, custGivenAmount, city, state, date, transaction, openingBalance, id, returnStatus, refId, fullPayment, partialPayment, finaltotal as total FROM invoices WHERE login='$login' $dd AND transaction='Out' AND status='1' $c $mm";
								$sno = 0;
